...
const ITStaff = () => {
  ...
  const titles = [
    ...
    {
      title:
        "30+ senior engineers are ready to extend the capacity of your team. ",
    },
    {
      title:
    ...
    {
      title:
        "Your project data stays safe. We guarantee the security of all data which relates to your project.",
    },
    {
      title:
        "We work honestly and openly. We have a transparent hiring process and offer fair rates.",
    },
  ];
    ...
    <>
        ...
        <div className="globalContainer">
          ...
          <div className={styles.titles}>
            ...
            <p className={styles.titles__text}>
              Ready-to-go and a custom-hired team of software engineers, Scrum
              Masters, Designers, and QA specialists just for your project
            </p>
          ...
          <div className={styles.card3_wrapper}>
            <div className={styles.card3_wrapper_card}>
              <FlexCard
                ...
                text={
                  "You get access to a distinct set of skills that will be helpful to your project."
                }
              />
              <FlexCard
                img={ITStaffGetCard2}
                ...
                text={
                  "We can scale up and down the number of developers during the cooperation on your demand."
                }
              />
            </div>
            <div className={styles.card3_wrapper_card}>
              ...
              <FlexCard
                ...
                text={
                  "Our specialists are ready to establish development processes for your in-house team or adhere to the existing ones."
                }
              />
            </div>
          </div>
      ...
      <section className={styles.container5}>
        <div className="globalContainer">
          ...
          <p className={styles.title5_text}>
            Our deep talent pool to support virtually any tech stack means we
            can serve up that one key professional that will complete your team,
            or we can be your team.
          </p>
          <div className={styles.card5_wrapper}>
            <div className={styles.card5_wrapper_card}>
              <SoftwareCard
                ...
                subtitle={
                  "Staff augmentation with developers that have solid experience building web apps using modern frameworks, high-level programming languages, and other tools. Our talent pool is perfectly able to complete your team. "
                }
              />
              <SoftwareCard
                clas={false}
        ...
        <div className="globalContainer">
          ...
          <div className={styles.texts}>
            <p className={styles.texts__text}>
              Our deep talent pool to support virtually any tech stack means we
              can serve up that one key professional that will complete
            </p>
            <p className={styles.texts__text}>
              your team, or we can be your team.
            </p>
          </div>
          <div className={styles.card6_wrapper}>
            <SoftwareCard
              ...
              subtitle={
                "Team augmentation with IT experts for a limited scope of work that should be done urgently"
              }
            />
            <hr />
            <SoftwareCard
              ...
              subtitle={
                "It implies long-lasting cooperation during the development lifecycle of your project."
              }
            />
          </div>
        </div>
