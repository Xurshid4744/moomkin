  ...
  return (
    <>
      <section className={styles.container}>
        <div className="globalContainer">
          ...
          <div className={styles.titles}>
            <h1 className={styles.titles__title}>
              Ad Tech and Marketing Software Development Services
            </h1>
            <p className={styles.titles__text}>
              Ad Tech software opens new ways for user acquisition, an increase
              of user engagement, interaction and behavior analytics.
              Advertising technology experienced huge growth in 2020, the whole
              ecosystem of sales and advertising is becoming stronger, more
              flexible, effective, and transparent.
            </p>
      ...
      <section style={{ paddingTop: "20px" }} className="globalContainer">
        <Title
          color={"#000"}
          title={"Reach Your Goals With AdTech Solutions"}
        />
        <div className={styles.texts}>
          <p className={styles.text}>
            The opportunities that custom marketing software opens to businesses
            are endless. First of all, we help companies
          </p>
          <p className={styles.text}>
            {" "}
            to optimize their sales and marketing strategy and set and reach new
            business goals.
          </p>
        </div>
