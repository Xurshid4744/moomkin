...
const Commerce = () => {
  ...
  const titles = [
    {
      title: "A software development company with strong experience in eCommerce applications development using various technologies and platforms."
    },
    {
      title: "Our team consists of highly skilled designers that have built a bunch of eCommerce platforms. They design good-selling UX/UI interfaces and clear user-friendly shopping cards for custom eCommerce solutions and mobile apps."
    },
    {
      title: "A comprehensive quality testing approach, including functional and load testing, makes sure your eCommerce application will manage lots of users."
    },
    {
      title: "Transparency of the entire software development life cycle."
    },
    {
      title: "We offer impressive quality for a moderate eCommerce website development cost."
    },
    {
      title: "Our digital solutions bring real value to businesses and end-users."
    },
  ]
  ...
  return (
    <>
      ...
      <section style={{ paddingBottom: "150px" }}>
        <div className="globalContainer">
          <h1 className={styles.ecommere_title}>Ecommerce App Development Services For Any Business</h1>
          <CardFlex />
        </div>
      </section>
      ...
      <section className={styles.choose_card}>
        <div className="globalContainer">
          <Title title={"Choose An Effective Way To Build  ECommerce Platform"} />
          <div className={styles.texts}>
            <p className={styles.text}>Custom eCommerce application development is not the ultimate one-stop solution. To ensure the best quality of</p>
            <p className={styles.text}>software development services and accelerate the release of the eCommerce web app, we use the Spree Commerce</p>
